...
BEGIN
  ...
  -- Seed knowledge docs
  INSERT INTO public.knowledge_docs (user_id, name, type, size_bytes, status)
  VALUES
    (p_user_id, 'Customer FAQ — Returns & Refunds.pdf', 'file', 819200,  'indexed'),
    (p_user_id, 'Product Catalog Q1 2025.docx',          'file', 1258291, 'indexed');
